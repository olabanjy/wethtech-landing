...
const HomeHeader = () => {
  return (
    <HeaderLayout>
      <section className="px-6 pt-[4.7rem]">
        <h3 className="max-w-[50.56rem] mx-auto mb-5 font-semibold text-[3.25rem] leading-16 text-center text-gray-800">
          Scale your business with <br className="md:block hidden" /> smart
          finance & tax compliance technologies
        </h3>
        <p className="max-w-[26rem] mx-auto text-center text-gray-600 mb-16">
